...
<head>
  ...
  <title>HOME PAGE - MoviesNow</title>
...
<div class="flex space-x-6 items-center">
          ...
          <a href="offers.php" class="flex items-center text-black hover:text-green-500 group">
            <i class="fas fa-gift mr-2 text-pink-500 group-hover:text-green-500"></i>
            Offers
          </a>

          <a href="contact.html" class="flex items-center text-black hover:text-green-500 group">
            <i class="fas fa-envelope mr-2 text-pink-500 group-hover:text-green-500"></i>
            Contact
          </a>

          <a href="About.html" class="flex items-center text-black hover:text-green-500 group">
            <i class="fas fa-info-circle mr-2 text-pink-500 group-hover:text-green-500"></i>
            About
          </a>
          ...
          <a href="<?php echo isset($_SESSION['user_id']) ? 'dashboard.php' : 'login.php'; ?>" class="flex items-center text-white/90 hover:text-white group px-4 py-2 rounded-lg transition duration-300 bg-gradient-to-r from-indigo-500 to-cyan-400 hover:from-cyan-400 hover:to-indigo-500 shadow-lg">
            <i class="fas fa-tachometer-alt mr-2 text-pink-200 group-hover:text-white"></i>
            Dashboard
          </a>

          <a href="<?php echo isset($_SESSION['user_id']) ? 'seasonpass.html' : 'login.php'; ?>" class="flex items-center text-white/90 hover:text-white group px-4 py-2 rounded-lg transition duration-300 bg-gradient-to-r from-indigo-500 to-cyan-400 hover:from-cyan-400 hover:to-indigo-500 shadow-lg">
            <i class="fas fa-ticket-alt mr-2 text-pink-200 group-hover:text-white"></i>
            SeasonPass
          </a>
...
<div class="relative bg-white/10 border border-white/20 rounded-lg shadow-lg hover:scale-110 transition transform duration-300 overflow-hidden group cursor-pointer">
<a href="<?= $redirect_url ?>" class="absolute inset-0 z-10"></a>
    <img src="img/p6.jpg" alt="Image not found" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button class="bg-gradient-to-r from-indigo-500 to-cyan-400 text-black px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition-colors duration-300">Book Now</button>
    </div>
</div>
...
<div class="relative bg-white/10 border border-white/20 rounded-lg shadow-lg hover:scale-110 transition transform duration-300 overflow-hidden group cursor-pointer">
<a href="<?= $redirect_url ?>" class="absolute inset-0 z-10"></a>
    <img src="img/p5.jpg" alt="Image not found" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button class="bg-gradient-to-r from-indigo-500 to-cyan-400 text-black px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition-colors duration-300">Book Now</button>
    </div>
</div>
...
<div class="relative bg-white/10 border border-white/20 rounded-lg shadow-lg hover:scale-110 transition transform duration-300 overflow-hidden group cursor-pointer">
<a href="<?= $redirect_url ?>" class="absolute inset-0 z-10"></a>
    <img src="img/p1.jpg" alt="Image not found" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button class="bg-gradient-to-r from-indigo-500 to-cyan-400 text-black px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition-colors duration-300">Book Now</button>
    </div>
</div>
...
<div class="relative bg-white/10 border border-white/20 rounded-lg shadow-lg hover:scale-110 transition transform duration-300 overflow-hidden group cursor-pointer">
<a href="<?= $redirect_url ?>" class="absolute inset-0 z-10"></a>
    <img src="img/p2.jpg" alt="Image not found" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button class="bg-gradient-to-r from-indigo-500 to-cyan-400 text-black px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition-colors duration-300">Book Now</button>
    </div>
</div>
...
<div class="relative bg-white/10 border border-white/20 rounded-lg shadow-lg hover:scale-110 transition transform duration-300 overflow-hidden group cursor-pointer">
<a href="<?= $redirect_url ?>" class="absolute inset-0 z-10"></a>
    <img src="img/p3.jpg" alt="Image not found" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button class="bg-gradient-to-r from-indigo-500 to-cyan-400 text-black px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition-colors duration-300">Book Now</button>
    </div>
</div>
...
<div class="relative bg-white/10 border border-white/20 rounded-lg shadow-lg hover:scale-110 transition transform duration-300 overflow-hidden group cursor-pointer">
<a href="<?= $redirect_url ?>" class="absolute inset-0 z-10"></a>
    <img src="img/p4.jpg" alt="Image not found" class="w-full h-full object-cover" />
    <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button class="bg-gradient-to-r from-indigo-500 to-cyan-400 text-black px-4 py-2 rounded-full font-semibold shadow-lg hover:bg-yellow-500 transition-colors duration-300">Book Now</button>
    </div>
</div>
      ...
      <div class="container mx-auto px-6 grid md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <p class="text-black mt-2 text-sm">
            MoviesNow is your go-to platform for booking tickets to the best movies, concerts, and events.
        ...
        <div>
          ...
          <ul class="mt-2 space-y-2">
            <li><a href="About.html" class="text-black hover:text-yellow-400 transition">About</a></li>
            <li><a href="events.html" class="text-black hover:text-yellow-400 transition">Events</a></li>
        ...
        <div>
          ...
          <p class="text-black mt-2 text-sm">
  📍 <a href="https://www.google.com/maps/place/Mirzapur,+Uttar+Pradesh,+India" target="_blank" class="text-black-600 hover:underline">Mirzapur, India</a> <br>
  📞 <a href="tel:+919369572534" class="text-black hover:underline">+91 9369572534</a> <br>
  ✉ <a href="mailto:ambuj20maurya@gmail.com" class="text-black hover:underline">ambuj20maurya@gmail.com</a>
</p>

        </div>
      </div>
      <div class="mt-10 text-center border-t border-gray-700 pt-4">
        <p class="text-sm text-black">&copy; 2025 MoviesNow. All rights reserved.</p>
...
<script>
  ...
  <!-- Cookie Consent Banner without Gradient -->
  <div id="cookieBanner" class="fixed bottom-6 left-6 right-6 z-50 bg-white text-black px-6 py-4 md:px-10 md:py-5 shadow-2xl rounded-xl animate-banner-slide flex flex-col md:flex-row justify-between items-center gap-4">
    <div class="text-sm md:text-base font-medium text-center md:text-left">
      🍪 We use cookies to personalize your experience. By continuing to visit this site, you agree to our use of cookies.
    </div>
    <div class="flex gap-4">
      <button id="acceptCookie" class="bg-blue-600 text-white px-6 py-2 font-semibold rounded-md hover:bg-blue-700 transition duration-300">
        Accept
      </button>
      <button id="declineCookie" class="bg-gray-200 text-black px-6 py-2 font-semibold rounded-md hover:bg-gray-300 transition duration-300">
        Decline
      </button>
    </div>
  </div>
  ...
  <style>
    ...
    .animate-banner-slide {
      animation: banner-slide 0.6s ease-out forwards;
    }
  </style>
  ...
  <script>
    document.getElementById("acceptCookie").addEventListener("click", function () {
      document.cookie = "cookie_accepted=true; path=/; max-age=" + 30 * 24 * 60 * 60;
      document.getElementById("cookieBanner").style.display = "none";
    });

    document.getElementById("declineCookie").addEventListener("click", function () {
      document.cookie = "cookie_accepted=false; path=/; max-age=" + 30 * 24 * 60 * 60;
      document.getElementById("cookieBanner").style.display = "none";
    });
  </script>
<?php endif; ?>
